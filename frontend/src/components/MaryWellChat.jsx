        ...
        <Card className="fixed bottom-6 right-6 w-96 h-[700px] shadow-2xl z-50 flex flex-col" data-testid="mary-well-chat">
          ...
          <div className="px-4 pt-3 pb-2 border-t border-slate-200 bg-white">
            <div className="flex flex-wrap gap-2">
              ...
              <Button onClick={openCheckoutTanning} size="sm" className="bg-secondary text-white" data-testid="checkout-tanning-button"><ShoppingCart className="h-4 w-4 mr-1" /> Buy Tanning</Button>
              {!listening ? (
