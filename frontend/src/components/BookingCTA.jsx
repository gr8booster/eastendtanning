      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
        {primaryAction && (
          <Button 
            ...
            size="lg" 
            className="inline-flex items-center gap-2 bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] px-8 h-14 font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-200"
        ...
        {showCall && callNumber && (
          <a href={`tel:${callNumber}`} data-testid="booking-cta-call">
            <Button 
              variant="outline" 
              size="lg" 
              className="inline-flex items-center gap-2 px-6 h-14 font-semibold bg-white hover:bg-gray-50 transition-colors"
            >
