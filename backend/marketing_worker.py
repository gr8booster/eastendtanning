        ...
        <body style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto;">
            ...
            <div style="padding: 30px; background: #f9f9f9;">
                ...
                <div style="text-align: center; margin: 30px 0;">
                    <a href="https://tanning-chatbot.preview.emergentagent.com" style="background: #F59E0B; color: white; padding: 15px 30px; text-decoration: none; border-radius: 10px; font-weight: bold;">
                        Explore Services
                    </a>
                </div>
    ...
    "first_visit_reminder": {
        ...
        <body style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto;">
            <div style="padding: 30px; background: #f9f9f9;">
                ...
                <div style="text-align: center; margin: 30px 0;">
                    <a href="https://tanning-chatbot.preview.emergentagent.com" style="background: #14B8A6; color: white; padding: 15px 30px; text-decoration: none; border-radius: 10px; font-weight: bold;">
                        Chat with Mary
                    </a>
                </div>
            </div>
    ...
    "service_details": {
        ...
        <body style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto;">
            <div style="padding: 30px; background: #f9f9f9;">
                ...
                <div style="text-align: center; margin: 30px 0;">
                    <a href="https://tanning-chatbot.preview.emergentagent.com/tanning" style="background: #F59E0B; color: white; padding: 15px 30px; text-decoration: none; border-radius: 10px; font-weight: bold;">
                        View Packages
                    </a>
                </div>
            </div>
    ...
    "limited_time_offer": {
        ...
        <body style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto;">
            ...
            <div style="padding: 30px; background: #f9f9f9;">
                ...
                <div style="text-align: center; margin: 30px 0;">
                    <a href="https://tanning-chatbot.preview.emergentagent.com" style="background: #E11D48; color: white; padding: 15px 30px; text-decoration: none; border-radius: 10px; font-weight: bold;">
                        Use My Code
                    </a>
                </div>
            </div>
