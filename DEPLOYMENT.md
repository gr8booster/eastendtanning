...
- **Live URL**: https://eastend-connect.preview.emergentagent.com
- **Admin**: https://eastend-connect.preview.emergentagent.com/admin
- **API Docs**: https://eastend-connect.preview.emergentagent.com/docs
...
1. **Uptime Robot**: Monitor https://eastend-connect.preview.emergentagent.com
...
#!/bin/bash
RESPONSE=$(curl -s https://eastend-connect.preview.emergentagent.com/health)
